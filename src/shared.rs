...
use super::{
	...
	FloopyContext, Result,
};

pub async fn get_conn(ctx: &FloopyContext<'_>) -> Result<Arc<Mutex<Call>>> {
...
pub async fn leave_channel(ctx: &FloopyContext<'_>) -> Result<(GuildId, ChannelId)> {
